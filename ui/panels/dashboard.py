...
ui/panels/dashboard.py — 🏠 Dashboard

Welcome to HBCE. Select a device to get started.
...
class DashboardPanel(QWidget):
    ...
    def __init__(self, config=None, db=None, current_user=None, parent=None):
        ...
        self._build_ui()
        logger.debug(f"DashboardPanel initialized")
    ...
    def _build_ui(self):
        ...
        # Description
        desc_label = QLabel("Welcome to HBCE. Select a device to get started.")
