...
ui/panels/connection_wizard.py — 🔌 Connection Wizard

Step-by-step device connection setup.
...
class ConnectionWizardPanel(QWidget):
    ...
    def __init__(self, config=None, db=None, current_user=None, parent=None):
        ...
        self._build_ui()
        logger.debug(f"ConnectionWizardPanel initialized")
    ...
    def _build_ui(self):
        ...
        title_label = QLabel("🔌 Connection Wizard")
        title_font = QFont()
        ...
        # Description
        desc_label = QLabel("Step-by-step device connection setup.")
