...
ui/panels/point_browser.py — 📋 Point Browser

Browse and edit BACnet / Modbus points on connected devices.
...
class PointBrowserPanel(QWidget):
    ...
    def __init__(self, config=None, db=None, current_user=None, parent=None):
        ...
        self._build_ui()
        logger.debug(f"PointBrowserPanel initialized")
    ...
    def _build_ui(self):
        ...
        title_label = QLabel("📋 Point Browser")
        title_font = QFont()
        ...
        # Description
        desc_label = QLabel("Browse and edit BACnet / Modbus points on connected devices.")
