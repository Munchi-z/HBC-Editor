...
ui/panels/scheduler.py — 📅 Scheduler

Edit weekly and exception schedules on controllers.
...
class SchedulerPanel(QWidget):
    ...
    def __init__(self, config=None, db=None, current_user=None, parent=None):
        ...
        self._build_ui()
        logger.debug(f"SchedulerPanel initialized")
    ...
    def _build_ui(self):
        ...
        # Description
        desc_label = QLabel("Edit weekly and exception schedules on controllers.")
