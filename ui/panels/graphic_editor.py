...
ui/panels/graphic_editor.py — 🧠 Program Editor

Node-based and FBD graphical programming editor.
...
class GraphicEditorPanel(QWidget):
    ...
    def __init__(self, config=None, db=None, current_user=None, parent=None):
        ...
        self._build_ui()
        logger.debug(f"GraphicEditorPanel initialized")
    ...
    def _build_ui(self):
        ...
        title_label = QLabel("🧠 Program Editor")
        title_font = QFont()
        ...
        # Description
        desc_label = QLabel("Node-based and FBD graphical programming editor.")
