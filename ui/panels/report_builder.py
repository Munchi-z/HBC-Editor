...
ui/panels/report_builder.py — 📄 Report Builder

Build and export PDF / Excel reports.
...
class ReportBuilderPanel(QWidget):
    ...
    def __init__(self, config=None, db=None, current_user=None, parent=None):
        ...
        self._build_ui()
        logger.debug(f"ReportBuilderPanel initialized")
    ...
    def _build_ui(self):
        ...
        title_label = QLabel("📄 Report Builder")
        title_font = QFont()
        ...
        # Description
        desc_label = QLabel("Build and export PDF / Excel reports.")
